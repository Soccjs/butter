...
exports.create = function(project_name, user_name, user_email, handler) {
	...
	var DIR_PROJECT = __DIR + project_name + '_'+user_name;
...
// JOIN A PROJECT
/////////////////////////////
exports.join = function(project_name, user_name, inv_usr, user_email, handler) {

	var DIR_PROJECT = __DIR + project_name + '_' + inv_usr;
	var DIR_PROJECT1 = __DIR + project_name + '_' + user_name;
	
	var DIR_PROJECT_ORIGIN = DIR_PROJECT + "/origin";
	var DIR_PROJECT_USER = DIR_PROJECT1 + "/_" + user_name;
